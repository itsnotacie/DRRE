...
from models.team08_drre.model import DRRE
...
def main(model_dir, input_path, output_path, device=None):
    ...
    parser.add_argument("--pretrained_model_path", type=str, default='pretrained_models/stable-diffusion-2-1-base')
    parser.add_argument('--pretrained_path', type=str, default='model_zoo/team08_drre/DRRE.pkl', help="path to a model state dict to be used")
    ...
    parser.add_argument("--lambda_sem", default=1.25, type=float, help="the scale for sementic-level enhancements")
    ...
    parser.add_argument("--residual_enhance_blocks", default=8, type=int, help="default 0 for unenable residual enhancement")
    parser.add_argument("--residual_enhance_block_dim", default=64, type=int)
